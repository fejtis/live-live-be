...
public record Context(LocationType locationType, Season season, Weather weather, Integer temperatureC, AgeRange ageRange, Duration availableTime, PrefferedStyle preferredStyle) {
    public Context {
